        ...
        return (
            <Link id="startBtn" to='/question/1'>
                <div className="BGBox">
                    ...
                    <p className="speech1"><span id="chiliWords">Beans in chili are the worst!</span></p>
                    <div id="chiligirlWave"></div>
                    <p className="speech2"><span id="uniWords">Neigh!</span></p>
                    <div id="unicornWave"></div>
                </div>
            </Link>
